...
export const setTopTracks = (topTacks) => ({type: SET_TOP_TRACKS, topTacks})
export const setSearchField = (searchField) => ({type: SET_SEARCH_FIELD, searchField})
export const setSearchResults = (searchResults) => ({type: SET_SEARCH_RESULTS, searchResults})
export const setTracksError = (error) => ({type: SET_TRACKS_ERROR, error})